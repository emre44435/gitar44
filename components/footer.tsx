    ...
    <footer className="border-t border-white/10 bg-[#070912]">
      <div className="site-container grid gap-12 py-16 md:grid-cols-[1.4fr_1fr_1fr] lg:py-20">
        <div>
          ...
          <p className="mt-5 max-w-md text-sm leading-7 text-muted">Darende’de gitarla tanışmak, doğru enstrümanı seçmek ve çalım konforunu korumak isteyenler için yerel bir buluşma noktası.</p>
