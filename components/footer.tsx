  ...
  return (
    <footer className="border-t border-white/10 bg-[#070912]">
      <div className="site-container grid gap-12 py-16 md:grid-cols-[1.4fr_1fr_1fr] lg:py-20">
        <div>
          <Link href="/" className="inline-flex items-center gap-3"><Guitar className="text-coral" aria-hidden="true" /><span className="font-display text-3xl">Darende Gitar Dersi</span></Link>
      ...
      <div className="border-t border-white/8"><div className="site-container flex flex-col gap-2 py-5 text-xs text-white/40 sm:flex-row sm:items-center sm:justify-between"><p>© {new Date().getFullYear()} Darende Gitar Dersi. Tüm hakları saklıdır.</p><p>Darende / Malatya</p></div></div>
    </footer>
  );
}
