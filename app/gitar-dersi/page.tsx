...
const data: DetailPageProps = {
  ...
  faq: [{ question: "Daha önce hiç gitar çalmadım, başlayabilir miyim?", answer: "Evet. Başlangıç gitar dersi, enstrümanı tanımadan doğru oturuş ve ilk seslere kadar sıfırdan planlanır." }, { question: "Ders için kendi gitarım olmalı mı?", answer: "Düzenli ev çalışması için kişisel bir gitar faydalıdır. Henüz gitarın yoksa beden ölçüsü, müzik hedefi ve bütçe yaklaşımına göre seçim desteği isteyebilirsin." }, { question: "Çocuklar için gitar dersi uygun mu?", answer: "Çocuğun yaşı, el yapısı, dikkat süresi ve ilgisi birlikte değerlendirilir. Uygun boy gitar seçimi de öğrenme konforunda önemlidir." }],
  message: "Merhaba, Darende gitar dersi hakkında bilgi almak istiyorum.", related: [{ label: "Gitar seçimi", href: "/gitar-satisi/" }, { label: "Klasik gitar", href: "/klasik-gitar/" }, { label: "İletişim", href: "/iletisim/" }],
};
