...
export const metadata: Metadata = pageMetadata("İletişim | Darende Gitar Dersi", "Darende’de birebir gitar dersi, uygun günler ve ders programı hakkında bilgi alın.", "/iletisim/");
...
export default function Page() {
  ...
  return <main>
    ...
    <section className="page-hero relative isolate overflow-hidden border-b border-white/10 pb-20 pt-32"><div className="hero-grid absolute inset-0 -z-20" /><div className="hero-glow absolute inset-0 -z-10" /><div className="site-container"><Breadcrumb current="İletişim" /><div className="grid gap-10 lg:grid-cols-[1.08fr_.92fr] lg:items-end"><div><p className="eyebrow mb-5">İletişim</p><h1 className="font-display text-[clamp(3.8rem,9vw,8rem)] leading-[.82] tracking-[-.045em]">Gitar dersine ilk adımı at.</h1></div><p className="pb-2 text-base leading-8 text-muted sm:text-lg">Seviyeni, yaşını, çalmak istediğin gitar türünü ve uygun olduğun günleri paylaş; ders programını birlikte planlayalım.</p></div></div></section>
