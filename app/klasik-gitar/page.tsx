...
export const metadata = pageMetadata("Darende Klasik Gitar Dersi | Darende Gitar Dersi", "Darende’de temel teknik, nota ve parmak çalışmaları odaklı birebir klasik gitar dersi alın.", "/klasik-gitar/");
