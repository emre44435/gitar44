  ...
  return (
    <main>
      ...
      <section className="hero-shell relative isolate overflow-hidden border-b border-white/10">
        <ViewportVideo src="/videos/studio-sound.mp4" mobileSrc="/videos/note-rain.mp4" poster="/video-posters/studio-sound.png" alt="Gitar ve kayıt ekipmanlarıyla turuncu ışıklı müzik stüdyosu" className="hero-banner-video absolute inset-0 -z-20" forceMotion />
        ...
        <div className="site-container flex min-h-[92svh] items-center pb-24 pt-28 lg:pb-28">
          <Reveal className="hero-copy relative z-10 w-full max-w-[64rem]">
            ...
            <h1 className="hero-title font-display"><span className="block">Özel</span><span className="block text-coral">Gitar Dersi</span></h1>
            <p className="mt-6 max-w-2xl text-base leading-7 text-white/72 sm:text-lg sm:leading-8">Darende, Malatya’da çocuklar, gençler ve yetişkinler için birebir gitar dersi. Seviyene ve müzik zevkine uygun klasik, akustik veya elektro gitar eğitimiyle ilk akordan sevdiğin şarkılara ilerle.</p>
