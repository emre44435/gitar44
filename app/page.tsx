...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section id="iletisim-cta" className="section-shell scroll-mt-24"><div className="site-container contact-stage"><div><p className="eyebrow mb-5">Darende / Malatya</p><h2 className="font-display text-[clamp(3rem,6vw,6.5rem)] leading-[.86] tracking-[-.04em]">İlk ders için tanışalım.</h2><p className="mt-6 max-w-xl text-base leading-8 text-muted">Seviyeni, yaşını ve çalmak istediğin müzikleri anlat. Sana uygun gitar dersi programını birlikte konuşalım.</p><div className="mt-8"><ContactActions message="Merhaba, Darende gitar dersi hakkında bilgi almak istiyorum." /></div></div><div className="contact-animation-stage"><Image src="/animations/singthesong.svg" alt="Birlikte gitar çalan iki müzisyenin animasyonu" fill sizes="(max-width: 767px) 92vw, 44vw" className="contact-animation-svg object-contain" /><Image src="/images/04-cocuk-gitar-dersi.webp" alt="" fill sizes="(max-width: 767px) 92vw, 44vw" className="contact-animation-static object-cover" /><span aria-hidden="true">Birlikte çal · Birlikte geliş</span></div></div></section>
    </main>
  );
}
