...
export const metadata = pageMetadata("Darende Birebir Gitar Dersi | Darende Gitar Dersi", "Darende’de seviyenize ve müzik hedefinize göre hazırlanan birebir gitar dersi programını inceleyin.", "/gitar-satisi/");
