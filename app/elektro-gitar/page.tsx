...
export const metadata = pageMetadata("Darende Elektro Gitar Dersi | Darende Gitar", "Darende’de riff, pena kontrolü ve sevilen parçalar odaklı birebir elektro gitar dersi alın.", "/elektro-gitar/");
