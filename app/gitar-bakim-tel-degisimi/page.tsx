...
export const metadata = pageMetadata("Darende Gitar Gelişim Programı | Darende Gitar", "Darende’de düzenli pratik, teknik gelişim ve şarkı çalışmaları odaklı birebir gitar dersi.", "/gitar-bakim-tel-degisimi/");
