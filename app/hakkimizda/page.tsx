...
export const metadata: Metadata = pageMetadata("Hakkımızda | Darende Gitar Dersi", "Darende Gitar Dersi’ın birebir ders yaklaşımını ve Darende’de müzik eğitimiyle kurduğu yerel bağı keşfedin.", "/hakkimizda/");
